...
import { Container, Grid, Card, Title, Text, TextInput, PasswordInput, Button, Stack, Group, ThemeIcon, Box, SegmentedControl } from "@mantine/core";
import { notifications } from "@mantine/notifications";
import { useAuthStore } from "../../stores/authStore";
import { IconTerminal2, IconLock, IconMail, IconUser, IconArrowRight } from "@tabler/icons-react";
  ...
  useEffect(() => {
    ...
    if (isError) {
      notifications.show({
        ...
        message: message || "Invalid registration information, please try again.",
        color: "red",
      });
      reset();
    }
          ...
          <Grid.Col span={{ base: 12, md: 5 }}>
            <Card p="xl" radius="md" withBorder>
              ...
              <Text size="sm" color="dimmed" mt="xl" style={{ textAlign: "center" }}>
                ...
                <Link to="/login" style={{ color: "var(--mantine-color-blue-filled)", textDecoration: "none", fontWeight: 600 }}>
                  Sign In
                </Link>
              </Text>
            </Card>
          ...
          <Grid.Col span={{ base: 12, md: 7 }} visibleFrom="md">
            ...
            >
              <Group mb="lg" gap="xs">
                ...
                <Text size="xs" color="dimmed" style={{ fontFamily: "var(--mantine-font-monospace)" }} ml={8}>sandbox_init.cpp</Text>
              </Group>

              <Box style={{ fontFamily: "var(--mantine-font-monospace)", fontSize: "0.9rem", color: "var(--mantine-color-text)", lineHeight: 1.6 }}>
                <Text style={{ color: "var(--mantine-color-blue-filled)" }}>#include <span style={{ color: "var(--mantine-color-indigo-filled)" }}>&lt;greencode.h&gt;</span></Text>
                <Text>&nbsp;</Text>
                <Text color="blue">int main() &#123;</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;Coder new_user;</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;new_user.set_level(LEVEL_BEGINNER);</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;new_user.unlock_sandbox();</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;<span style={{ color: "#f43f5e" }}>if</span> (new_user.is_authorized()) &#123;</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;std::cout &lt;&lt; <span style={{ color: "var(--mantine-color-red-filled)" }}>"Access Granted"</span> &lt;&lt; std::endl;</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;new_user.compile_and_run();</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;&#125;</Text>
                <Text>&nbsp;&nbsp;&nbsp;&nbsp;return 0;</Text>
